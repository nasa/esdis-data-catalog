...
export const SearchResultsList = ({
  ...
  const handleScroll = () => {
    ...
    }, 100) // Delay to ensure `window.scrollTo` has time to work
  }
        ...
        <Row>
          <Col className="search-results-header__summary">
            ...
            >
              ...
              {' of '}
              {commafy(collectionCount || 0, { thousands: true })}
              {' '}
...
SearchResultsList.propTypes = {
  ...
  setQueryPage: PropTypes.func.isRequired,
  setQueryPageSize: PropTypes.func.isRequired,
  setQuerySort: PropTypes.func.isRequired,
